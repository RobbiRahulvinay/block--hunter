...
<head>
<title>A_View_All_Posts_Categories</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
        <h1><a href="index.html" class="style6">Block Hunter: Federated Learning for Cyber Threat Hunting in Blockchain-based IIoT Networks</a></h1>
      </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style4">View All  Posts Categories</span></h2>
          <p>&nbsp;</p>
          <table width="619" align="center"  cellpadding="0" cellspacing="0" >
            <tr>
              ...
              <td width="209" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style27 style105 style65 style2 style3"><em><strong>Category Name </strong></em></div></td>
